! function(t) {
    ...
    var e = {
            ...
            thim_course_filter: function() {
                ...
                t(document).on("change", ".thim-course-order > select", function() {
                    ...
                    a.course_cate_filter = r, a.course_instructor_filter = l, a.s = t(".courses-searching .course-search-filter").val(), a.course_orderby = t(".thim-course-order > select").val(), a.course_paged = s, i(a)
            ...
            thim_menu: function() {
                var e = t("#masthead.sticky-header"),
                    ...
                    a = e.outerHeight(),
                    o = 0;
                t(window).scrollTop() > 2 && e.removeClass("affix-top").addClass("affix"), t(window).scroll(function() {
                    var n = t(this).scrollTop();
                    n > 2 ? e.removeClass("affix-top").addClass("affix") : e.removeClass("affix").addClass("affix-top"), n > o && n > a + i ? e.hasClass("menu-hidden") || e.addClass("menu-hidden") : e.hasClass("menu-hidden") && e.removeClass("menu-hidden"), o = n
                ...
                t("header#masthead").hasClass("header_v4") || function() {
                    if (t(window).width() > 768) {
                        ...
                        n.css("bottom", s - (s - 90) / 2 - 64), t("#masthead .navbar-nav>li.menu-item").on({
                            mouseenter: function() {
            ...
            check_load_menu: function() {
                ...
                if (i) {
                    ...
                    t(".width-navigation").find(".menu-main-menu").length ? e = "html_desktop" : a.length && (e = "html_mobile"), console.log(e), i = 0, setTimeout(function() {
                        t.ajax({
                            type: "post",
                            url: ajaxurl,
                            data: {
    ...
    t(document).ready(function() {
        e.ready(), t(window).resize(function(t) {})
