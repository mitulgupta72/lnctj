...
function(e) {
    e(window).on("load", function() {
        ...
        if (e(".course-wishlist-box [class*='course-wishlist']").on("click", function(t) {
                t.preventDefault();
                var i = e(this);
    ...
    e(document).ready(function() {
        ...
        o(".thim-carousel-instructors", ".instructor-item"), o(".thim-owl-carousel-post", ".image"), o(".thim-course-carousel", ".course-thumbnail"), s()
    }), e(document).ready(function() {
        ...
        var a = null;
        e(document).on("keydown", "body:not(.course-filter-active) .course-search-filter", function(t) {
            if (!t.ctrlKey) {
                if (13 === t.keyCode) return t.preventDefault(), !1;
                if (t.keyCode >= 48 && t.keyCode <= 90 || 8 === t.keyCode || 32 === t.keyCode) {
                    var i = e(this),
                        o = 8 === t.keyCode ? i.val() : i.val() + t.key,
                        s = e("body");
                    null != a && clearTimeout(a), a = setTimeout(function() {
                        i.attr("disabled", "disabled"), a = null, e("#thim-course-archive").addClass("loading");
                        var t = i.parents("#lp-archive-courses"),
                            n = [];
                        if (s.hasClass("category")) {
                            var r = s.attr("class").match(/category\-\d+/gi)[0].split("-").pop();
                            n.push(r)
                        }
                        e(".list-cate-filter").length > 0 && e(".list-cate-filter input.filtered").each(function() {
                            e(this).val() !== r && n.push(e(this).val())
                        }), e.ajax({
                            url: e("#lp-archive-courses").data("allCoursesUrl"),
                            type: "POST",
                            dataType: "html",
                            data: {
                                s: o,
                                ref: "course",
                                post_type: "lp_course",
                                course_orderby: e(".thim-course-order > select").val(),
                                course_cate_filter: n,
                                course_paged: 1
                            },
                            success: function(i) {
                                var a = e(i).find("#lp-archive-courses").html();
                                t.html(a), e(".course-search-filter").val(o).trigger("focus"), s.removeClass("course-filter-active"), e(".filter-loading").remove()
                            },
                            error: function() {
                                s.removeClass("course-filter-active"), e(".filter-loading").remove()
                            }
                        })
                    }, 1e3)
                }
